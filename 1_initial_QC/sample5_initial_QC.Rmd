...
counts <- Read10X("/path/to/cellranger_out/Sample5/outs/filtered_feature_bc_matrix/")
...
sample <- CreateSeuratObject(counts = counts$`Gene Expression`,
                               assay = "RNA",project = "sample5")
sample[['ATAC']] <- CreateChromatinAssay(counts = counts$`Peaks`,
                                           annotation = annotations,
                                           fragments = paste0("/path/to/cellranger_out/Sample5/outs/atac_fragments.tsv.gz"),sep = c(":", "-"),genome = 'hg38')
...
saveRDS(sample,"/path/to/data/preprocessing/sample5.rds")
